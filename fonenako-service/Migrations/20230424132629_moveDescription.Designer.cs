...
namespace fonenako_service.Migrations
{
    ...
    [Migration("20230424132629_moveDescription")]
    partial class moveDescription
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fonenako_service.Models.LeaseOfferDescription", b =>
                {
                    b.Property<int>("LeaseOfferDescriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("LeaseOfferDescriptionId")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.HasKey("LeaseOfferDescriptionId");

                    b.HasIndex("LeaseOfferId")
                        .IsUnique();

                    b.ToTable("LeaseOfferDescription");
                });
            ...
            modelBuilder.Entity("fonenako_service.Models.LeaseOfferDescription", b =>
                {
                    b.HasOne("fonenako.Models.LeaseOffer", "LeaseOffer")
                        .WithOne("LeaseOfferDescription")
                        .HasForeignKey("fonenako_service.Models.LeaseOfferDescription", "LeaseOfferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LeaseOffer");
                });
            ...
            modelBuilder.Entity("fonenako.Models.LeaseOffer", b =>
                {
                    b.Navigation("LeaseOfferDescription");
                });
