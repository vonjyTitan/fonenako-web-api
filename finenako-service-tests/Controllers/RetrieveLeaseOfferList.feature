...
Scenario: Retrieve lease offer list without any parameter
	Given The following list of lease offer is present in the system
		...
		|1            |Offer number 1 |65      |3    |750		 |2023-10-25  |image1.jpg;image2.jpg|
		|2            |Offer number 2 |18      |1    |950		 |2023-09-25  |image3.jpg;|
	...
	And The pageable content items should be like :
		...
		|2            |Offer number 2 |18      |1    |950		 |2023-09-25  |http://localhost:7182/Photos/image3.jpg|
		|1            |Offer number 1 |65      |3    |750		 |2023-10-25  |http://localhost:7182/Photos/image1.jpg;http://localhost:7182/Photos/image2.jpg|

Scenario: Retrieve lease offer list order by leaseOfferId asc
	Given The following list of lease offer is present in the system
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|ConcatenedPhotos			    |
		|1            |Offer number 1 |65      |3    |950		 |2023-09-25  |image1.jpg;image2.jpg|
		|2            |Offer number 2 |18      |1    |750		 |2023-10-25  |image3.jpg;|
	When I make a GET request on lease-offers endpoint with arguments 'orderBy=leaseOfferId&order=Asc'
	Then The response Status code should be '200'
	And The pageable infos should be like : {CurrentPage : '1', TotalPage : '1', PageSize : '10000', totalFound : '2'}
	And The pageable content items should be like :
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|PhotoUris|
		|1            |Offer number 1 |65      |3    |950		 |2023-09-25  |http://localhost:7182/Photos/image1.jpg;http://localhost:7182/Photos/image2.jpg|
		|2            |Offer number 2 |18      |1    |750		 |2023-10-25  |http://localhost:7182/Photos/image3.jpg|

Scenario: Retrieve lease offer list order by leaseOfferId desc
	Given The following list of lease offer is present in the system
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|ConcatenedPhotos			    |
		|1            |Offer number 1 |65      |3    |750		 |2023-09-25  |image1.jpg;image2.jpg|
		|2            |Offer number 2 |18      |1    |950		 |2023-10-25  |image3.jpg;|
	When I make a GET request on lease-offers endpoint with arguments 'orderBy=leaseOfferId&order=Desc'
	Then The response Status code should be '200'
	And The pageable infos should be like : {CurrentPage : '1', TotalPage : '1', PageSize : '10000', totalFound : '2'}
	And The pageable content items should be like :
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|PhotoUris|
		|2            |Offer number 2 |18      |1    |950		 |2023-10-25  |http://localhost:7182/Photos/image3.jpg|
		|1            |Offer number 1 |65      |3    |750		 |2023-09-25  |http://localhost:7182/Photos/image1.jpg;http://localhost:7182/Photos/image2.jpg|
...
Scenario: Retrieve lease offer list order by creationDate asc
	Given The following list of lease offer is present in the system
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|ConcatenedPhotos			    |
		|1            |Offer number 1 |65      |3    |950		 |2023-10-25  |image1.jpg;image2.jpg|
		|2            |Offer number 2 |18      |1    |750		 |2023-09-25  |image3.jpg;|
	When I make a GET request on lease-offers endpoint with arguments 'orderBy=creationDate&order=Asc'
	Then The response Status code should be '200'
	And The pageable infos should be like : {CurrentPage : '1', TotalPage : '1', PageSize : '10000', totalFound : '2'}
	And The pageable content items should be like :
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|PhotoUris|
		|2            |Offer number 2 |18      |1    |750		 |2023-09-25  |http://localhost:7182/Photos/image3.jpg|
		|1            |Offer number 1 |65      |3    |950		 |2023-10-25  |http://localhost:7182/Photos/image1.jpg;http://localhost:7182/Photos/image2.jpg|
...
Scenario: Retrieve lease offer list order by surface desc
	Given The following list of lease offer is present in the system
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|ConcatenedPhotos			    |
		|1            |Offer number 1 |18      |3    |750		 |2023-09-25  |image1.jpg;image2.jpg|
		|2            |Offer number 2 |65      |1    |950		 |2023-10-25  |image3.jpg;|
	When I make a GET request on lease-offers endpoint with arguments 'orderBy=surface&order=Desc'
	Then The response Status code should be '200'
	And The pageable infos should be like : {CurrentPage : '1', TotalPage : '1', PageSize : '10000', totalFound : '2'}
	And The pageable content items should be like :
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|PhotoUris			    |
		|2            |Offer number 2 |65      |1    |950		 |2023-10-25  |http://localhost:7182/Photos/image3.jpg|
		|1            |Offer number 1 |18      |3    |750		 |2023-09-25  |http://localhost:7182/Photos/image1.jpg;http://localhost:7182/Photos/image2.jpg|
...
Scenario: Retrieve lease offer list with both pagination and order
	Given The following list of lease offer is present in the system
		...
		|1            |Offer number 1 |65      |3    |750		 |2023-09-25  |image1.jpg;image2.jpg|
		|2            |Offer number 2 |18      |1    |950		 |2023-10-25  |image3.jpg;|
		|3            |Offer number 3 |18      |1    |1000		 |2023-10-25  |image4.jpg;|
	...
	And The pageable content items should be like :
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|PhotoUris|
		|3            |Offer number 3 |18      |1    |1000		 |2023-10-25  |http://localhost:7182/Photos/image4.jpg|
...
Scenario: Retrieve lease offer list with filter on surfaceMin
	Given The following list of lease offer is present in the system
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|ConcatenedPhotos			    |
		|1            |Offer number 1 |18      |3    |750		 |2023-09-25  |image1.jpg;image2.jpg|
		|2            |Offer number 2 |50      |1    |950		 |2023-10-25  |image3.jpg;|
		|3            |Offer number 2 |65      |2    |1000		 |2023-10-25  |image4.jpg;|
	When I make a GET request on lease-offers endpoint with filter : '{"surfaceMin":19}'
	Then The response Status code should be '200'
	And The pageable infos should be like : {CurrentPage : '1', TotalPage : '1', PageSize : '10000', totalFound : '2'}
	And The pageable content items should be like :
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|PhotoUris			    |
		|3            |Offer number 2 |65      |2    |1000		 |2023-10-25  |http://localhost:7182/Photos/image4.jpg|
		|2            |Offer number 2 |50      |1    |950		 |2023-10-25  |http://localhost:7182/Photos/image3.jpg|
																			   
Scenario: Retrieve lease offer list with filter on rooms
	Given The following list of lease offer is present in the system
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|ConcatenedPhotos			    |
		|1            |Offer number 1 |18      |1    |750		 |2023-09-25  |image1.jpg;image2.jpg|
		|2            |Offer number 2 |50      |2    |950		 |2023-10-25  |image3.jpg;|
		|3            |Offer number 2 |65      |2    |1000		 |2023-10-25  |image4.jpg;|
	...
	And The pageable content items should be like :
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|PhotoUris			    |
		|3            |Offer number 2 |65      |2    |1000		 |2023-10-25  |http://localhost:7182/Photos/image4.jpg|
		|2            |Offer number 2 |50      |2    |950		 |2023-10-25  |http://localhost:7182/Photos/image3.jpg|
...
Scenario: Retrieve lease offer list with combined filters
	Given The following list of lease offer is present in the system
		...
		|2            |Offer number 2 |40      |1    |900		 |2023-10-25  |image3.jpg;|
		|3            |Offer number 3 |56      |2    |1000		 |2023-10-25  |image4.jpg;|
		|4            |Offer number 4 |65      |3    |1000		 |2023-11-25  |image5.jpg;|
		|5            |Offer number 5 |80      |3    |1500		 |2023-11-25  |image6.jpg;|
	When I make a GET request on lease-offers endpoint with filter : '{"monthlyRentMin":900,"surfaceMax":64}'
	Then The response Status code should be '200'
	And The pageable infos should be like : {CurrentPage : '1', TotalPage : '1', PageSize : '10000', totalFound : '2'}
	And The pageable content items should be like :
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|PhotoUris			    |
		|3            |Offer number 3 |56      |2    |1000		 |2023-10-25  |http://localhost:7182/Photos/image4.jpg|
		|2            |Offer number 2 |40      |1    |900		 |2023-10-25  |http://localhost:7182/Photos/image3.jpg|
...
Scenario: Retrieve lease offer list with both filter and pagination
	Given The following list of lease offer is present in the system
		...
		|1            |Offer number 1 |18      |3    |800		 |2023-09-25  |image1.jpg;image2.jpg|
		|2            |Offer number 2 |40      |1    |900		 |2023-10-25  |image3.jpg;|
		|3            |Offer number 3 |56      |2    |950		 |2023-10-25  |image4.jpg;|
		|4            |Offer number 4 |65      |3    |1000		 |2023-11-25  |image5.jpg;|
		|5            |Offer number 5 |80      |3    |1500		 |2023-11-25  |image6.jpg;|
	...
	And The pageable content items should be like :
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|PhotoUris			    |
		|3            |Offer number 3 |56      |2    |950		 |2023-10-25  |http://localhost:7182/Photos/image4.jpg|
		|2            |Offer number 2 |40      |1    |900		 |2023-10-25  |http://localhost:7182/Photos/image3.jpg|

Scenario: Retrieve lease offer list with filter that does not have macthing
	Given The following list of lease offer is present in the system
		|LeaseOfferID |Title          |Surface |Rooms|MonthlyRent|CreationDate|ConcatenedPhotos			    |
		|1            |Offer number 1 |18      |3    |800		 |2023-10-25  |image1.jpg;image2.jpg|
		|2            |Offer number 2 |40      |1    |900		 |2023-09-25  |image3.jpg;|
